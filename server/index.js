...
// render the page with empty fields load
...
app.post('/signup', (req, res) => {
  ...
  // create a variable that returns TRUE if the email is valid, or an error message if it is not
  ...
  if (isValidSignUp !== true) {
    // render error message, but leave all input fields filled out
    res.render('signup', {
      emailWarning: isValidSignUp,
...
app.post('/login', (req, res) => {
  ...
  // valid user: isValidUser.user !=null...
  ...
  if (isValidUser.user === null) {
    // return req.body.email, req.body.password will leave the entered
    // email/password in the fields 
    res.render('login', {
